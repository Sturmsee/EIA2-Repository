namespace birds {
    ...
    function paintBirds(): void {
        let colors: string[] = ["blue", "red", "lime", "yellow", "cyan", "violet", "black", "orange"];
        ...
        for (let i = 0; i < 20; i++) {
            ...
            let positionX: number = Math.floor(Math.random() * 399) + 400;
            let positionY: number = Math.floor(Math.random() * 600);
